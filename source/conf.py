...
man_pages = [
    (master_doc, 'pythonGIS', 'Python GIS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Python GIS', 'Python GIS Documentation',
     author, 'Python GIS', 'One line description of project.',
     'Miscellaneous'),
]
...
.. only:: html
    ...
    .. nbinfo::
        ...
        :raw-html:`<a href="https://mybinder.org/v2/gh/Automating-GIS-processes/notebooks-csc/master?urlpath=lab/tree/{{ docname2 }}"><img alt="Binder badge" src="https://img.shields.io/badge/launch-student%20binder-red.svg" style="vertical-align:text-bottom"></a>`
